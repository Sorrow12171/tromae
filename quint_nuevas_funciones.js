...
function cargarPaginaQuintillizas() {
    ...
    seccion.innerHTML = `
        ...
        <style>
            ...
            .quint-img-wrapper { margin-top:10px; border-radius:10px; overflow:hidden; max-width:320px; border:1px solid rgba(255,255,255,0.08); background:rgba(0,0,0,0.2); min-height:50px; display:block !important; visibility:visible !important; }
            .quint-img { width:100% !important; display:block !important; position:relative !important; z-index:1 !important; visibility:visible !important; opacity:1 !important; max-width:100% !important; height:auto !important; object-fit:contain !important; min-height:50px; }
